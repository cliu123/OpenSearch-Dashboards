...
import { IndexMapping } from '../../../../core/server/saved_objects/mappings';
import {
  buildActiveMappings,
  DocumentMigrator,
  IndexMigrator,
  MigrationOpenSearchClient,
} from '../../../../core/server/saved_objects/migrations/core';
import { createIndexMap } from '../../../../core/server/saved_objects/migrations/core/build_index_map';
import { mergeTypes } from '../../../../core/server/saved_objects/migrations/opensearch_dashboards/opensearch_dashboards_migrator';
